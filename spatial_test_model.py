...
def main(args):
    ...
    if hasattr(test_loader.dataset, 'ethnicity_columns'):
        ...
        if 'test_pop_2001' in data:
            ethnicity_names = [col for col in data['test_pop_2001'].columns if col != 'DAUID']
    ...
    try:
        ...
        # Check if test data has ground truth (2006 population)
        has_ground_truth = any(f"{k}_2006" in data for k in ['test_pop', 'test_pop_2006'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--colonization_weight", type=float, default=8.05266659034115,
                        help="Weight for colonization loss")
    ...
    parser.add_argument("--weight_decay", type=float, default=6.323728543271069e-07,
                        help="Weight decay for optimizer (only used for training)")
