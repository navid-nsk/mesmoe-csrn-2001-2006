...
```
data/
├── 2001_train_features_all.csv
├── 2001_train_population_all.csv
├── 2006_train_population_all.csv
├── 2001_val_features_all.csv
├── 2001_val_population_all.csv
├── 2006_val_population_all.csv
├── 2001_test_features_all.csv
├── 2001_test_population_all.csv
